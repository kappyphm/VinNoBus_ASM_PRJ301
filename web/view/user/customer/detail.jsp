            ...
            <div class="mt-6 grid grid-cols-1 md:grid-cols-[180px_1fr] gap-6">
                ...
                <div class="rounded-2xl border border-slate-200 bg-white p-4 shadow-soft">
                    ...
                    <div class="mt-6 flex flex-wrap gap-3">
                        <a href="${ctx}/customer/update?id=${userDetail.userId}" class="px-3 py-2 rounded-xl bg-brand-600 text-white text-sm hover:bg-brand-700 shadow-soft">Chỉnh sửa</a>
                        <a href="${ctx}/customer/delete?id=${userDetail.userId}" class="px-3 py-2 rounded-xl bg-red-600 text-white text-sm hover:bg-red-700 shadow-soft">Xóa</a>
                    </div>
                </div>
            </div>
