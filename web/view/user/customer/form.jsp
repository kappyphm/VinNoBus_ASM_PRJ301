...
<ui:layout>
    <jsp:attribute name="title">Cập nhật người dùng</jsp:attribute>
    ...
    <jsp:body>
        <main class="max-w-4xl mx-auto px-5 py-8">
            ...
            <c:set var="path" value="${not empty sessionScope.user.staff ? 'update?id='+userDetail.userId : 'update'}" />
            <!-- ProfileForm -->
            <form action="${ctx}/profile/${path}" method="POST"
                ...
                <div class="pt-4 flex gap-3">
                    ...
                    <a href="${ctx}/customer/detail?id=${userDetail.userId}"
