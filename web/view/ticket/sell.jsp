    ...
    <body class="bg-brand-50 min-h-screen flex items-center justify-center font-mono text-slate-800">
        ...
        <div class="bg-white rounded-2xl shadow-soft p-6 w-full max-w-md border border-slate-200">
            ...
            <c:if test="${not empty error}">
                <div class="mb-3 px-3 py-2 text-[13px] bg-red-100 text-red-700 border border-red-300 rounded-md">
                    ⚠️ ${error}
                </div>
            </c:if>

            <c:if test="${not empty message}">
                <div class="mb-3 px-3 py-2 text-[13px] bg-green-100 text-green-700 border border-green-300 rounded-md">
                    ✅ ${message}
                </div>
            </c:if>
        </div>
