...
public class UserDAO extends DBContext implements IUserDAO {
    ...
    public void save(User user) throws SQLException {
        PreparedStatement st = connection.prepareStatement(SAVE_USER);
    }
    ...
    @Override
    public void delete(UUID uid) throws SQLException {
        throw new UnsupportedOperationException("Not supported yet."); // Generated from nbfs://nbhost/SystemFileSystem/Templates/Classes/Code/GeneratedMethodBody
    }

    @Override
    public User findByUid(UUID uid) throws SQLException {
        throw new UnsupportedOperationException("Not supported yet."); // Generated from nbfs://nbhost/SystemFileSystem/Templates/Classes/Code/GeneratedMethodBody
    }
